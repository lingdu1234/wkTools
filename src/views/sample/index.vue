  ...
  <el-dialog :title="title" v-model="open" width="400px" append-to-body>
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="医院名称" prop="name">
        <el-input disabled class="form_item" v-model="hospitalsMap[queryParams.hospital_id]" placeholder="医院名称" />
      </el-form-item>
      ...
      <el-form-item v-if="isUploadSample" label="Excel上传">
        <el-upload multiple ref="uploadSoft" accept=".xls, .xlsx" action="" :auto-upload="false" :show-file-list="false"
          :on-change="handleChangeSoftExcel">
      ...
      <el-form-item v-if="!isUploadSample">
        ...
        <el-upload multiple ref="uploadDir" accept=".xls, .xlsx" action="" :auto-upload="false" :show-file-list="false"
          :on-change="handleChangeDirExcel">
